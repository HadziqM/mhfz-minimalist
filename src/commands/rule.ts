...
const command : Command = {
    ...
    execute: async (message, args) => {
        ...
        const embed4 = new EmbedBuilder().setTitle('Enclosure ').setDescription('Every acts of serious violators including or other than those stated in the rule will be subject to sanctions in the form of expulsion of members who violate').setColor('Red').setFooter({text:`Thank you for your attention, warm regards and HAPPY HUNTING!!`,iconURL:message.author.displayAvatarURL()})
        ...
        message.channel.send({components:[button],embeds:[embed1,embed2,embed3,jp_embed1,jp_embed2,jp_embed3,embed4]})
    },
    cooldown: 10,
    aliases: ["sayrule"],
